...
// average normals
	...
	GLfloat cubo_vertices[] = {
		...
		0.5f,  0.5f,  0.5f,	     0.76f,	0.66f,		-1.0f,	0.0f,	0.0f,//7
		// back
		-0.5f, -0.5f, -0.5f,	0.74f,  0.01f,		0.0f,	0.0f,	1.0f,//8
		0.5f, -0.5f, -0.5f,		0.51f,	0.01f,		0.0f,	0.0f,	1.0f,//9
		0.5f,  0.5f, -0.5f,		0.51f,	0.33f,		0.0f,	0.0f,	1.0f,//10
		-0.5f,  0.5f, -0.5f,	0.74f,	0.33f,		0.0f,	0.0f,	1.0f,//11

		// left
		//x		y		z		S		T
		-0.5f, -0.5f,  -0.5f,	0.51f,   0.68f,		1.0f,	0.0f,	0.0f,//12
		-0.5f, -0.5f,  0.5f,	0.74f,	0.68f,		1.0f,	0.0f,	0.0f,//13
		-0.5f,  0.5f,  0.5f,	0.74f,	0.98f,		1.0f,	0.0f,	0.0f,//14
		-0.5f,  0.5f,  -0.5f,	0.51f,	0.98f,		1.0f,	0.0f,	0.0f,//15
		...
		//UP
		 //x		y		z		S		T
		 -0.5f, 0.5f,  0.5f,	0.26f,  0.34f,		0.0f,	-1.0f,	0.0f,//20
		 0.5f,  0.5f,  0.5f,	0.5f,	0.34f,		0.0f,	-1.0f,	0.0f,//21
		  0.5f, 0.5f,  -0.5f,	0.5f,	0.66f,		0.0f,	-1.0f,	0.0f,//22
		 -0.5f, 0.5f,  -0.5f,	0.26f,	0.66f,		0.0f,	-1.0f,	0.0f,//23
...
int main()
{
	...
	dadoTexture = Texture("Textures/ImagenNumerosModificada.png");
	dadoTexture.LoadTextureA();
	logofiTexture = Texture("Textures/escudo_fi_color.tga");
	logofiTexture.LoadTextureA();
	llantaTexture = Texture("Textures/LLantaAjustada.png");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, carMovementZ - 4.0f));
