...
int main()
{
	...
	*/
	...
	glm::mat4 modelPata(1.0);
	glm::mat4 modelPataSup(1.0);
	glm::mat4 modelPataInf(1.0);
	glm::mat4 modelCola(1.0);
	glm::mat4 modelColaFinal(1.0);
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(4.5f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.0f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		model = glm::translate(model, glm::vec3(1.5f, 2.5f, 1.9f));
		...
		model = modelLlanta;
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(-1.5f, 5.5f, 1.9f));
		...
		model = modelLlanta;
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(1.0f, 5.5f, 1.9f));
		...
		model = glm::scale(model, glm::vec3(0.75f, 1.75f, 0.75f));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		//cabeza
		model = glm::translate(model, glm::vec3(0.5f, 2.0f, -4.0f));
		model = glm::scale(model, glm::vec3(1.5f, 1.5f, 1.5f));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.608f, 0.608f, 0.608f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		sp.render();
		model = modelaux;
		...
		model = glm::translate(model, glm::vec3(2.0f, 2.75f, -3.5f));
		model = glm::scale(model, glm::vec3(0.2f, 0.75f, 0.25f));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.4f, 0.4f, 0.4f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		...
		model = glm::rotate(model, glm::radians(35.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(2.0f, 2.75f, -4.5f));
		model = glm::scale(model, glm::vec3(0.2f, 0.75f, 0.25f));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		color = glm::vec3(0.4f, 0.4f, 0.4f);
		...
		// Base de la pata (matriz inicial)
		modelPata = model;

		// Articulación 1 (superior) izquierda frontal
		model = modelPata;
		model = glm::translate(model, glm::vec3(3.0f, -0.5f, -3.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		color = glm::vec3(0.2196f, 0.2196f, 0.2196f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		sp.render();
		...
		//Articulación 1 (superior) izquierda trasera
		model = modelPata;
		...
		// Articulación 1 (superior) derecha frontal
		model = modelPata;
		...
		// Articulación 1 (superior) derecha trasera
		model = modelPata;
		...
		//articulación cola
		model = modelCola;
		model = glm::translate(model, glm::vec3(5.75f, 0.5f, -4.0f));
		...
		modelColaFinal = model;
		model = glm::scale(model, glm::vec3(6.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();

		model = modelColaFinal;
		//segunda articulación cola
		model = glm::translate(model, glm::vec3(2.0f, 0.0f, 0.0f));
