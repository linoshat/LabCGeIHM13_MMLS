...
int main()
{
	...
	frontDer = Model();
	frontDer.LoadModel("Models/frontal1.obj");
	traseraDer = Model();
	traseraDer.LoadModel("Models/trasera1.obj");
	frontIzq = Model();
	frontIzq.LoadModel("Models/frontal1.obj");
	traseraIzq = Model();
	traseraIzq.LoadModel("Models/trasera1.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		model = glm::translate(model, glm::vec3(2.5f, 1.0, -0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(1.0f, -0.4f, 0.7f));
		modelaux = model;	
		...
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		frontDer.RenderModel();
		
		
		//pada trasera derecha
		model = modelaux;
		...
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		traseraDer.RenderModel();


		//pata delantera izq
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.5f, 0.5f, -1.4f));
		modelaux = model;
